...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        tfk.layers.Conv1D(filters=64, kernel_size=5, activation='relu', input_shape=(N_PAST, N_FEATURES)),
        #tfk.layers.MaxPool1D(2),
    ...
    optimizer = tfk.optimizers.SGD(learning_rate=1e-5, momentum=0.9)
    model.compile(
